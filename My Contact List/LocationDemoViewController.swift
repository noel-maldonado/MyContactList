...
class LocationDemoViewController: UIViewController, CLLocationManagerDelegate {
    ...
    @objc func dismissKeyboard() {
        // Causes the view (or one of its embedded text fields) to resing the first responder status.
    ...
    override func viewDidLoad() {
        ...
        locationManager.requestWhenInUseAuthorization() // ask permission to use location
